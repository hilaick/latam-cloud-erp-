...
export default function PreSalesRadar() {
    ...
    const targetCountries = ["Mexico", "Panama", "Guatemala", "Colombia", "Chile", "Peru", "Argentina", "Brazil", "Costa Rica", "Ecuador", "Other / TBD"];
                        ...
                        <div className="p-8 overflow-y-auto bg-slate-50 space-y-8">
                            ...
                            <div className="bg-white p-6 rounded-xl border border-slate-200">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                                    <div><label className="block text-[10px] font-bold text-slate-500 uppercase mb-1">Source Environment</label><input type="text" placeholder="e.g. VMware" value={editingProject.sourceEnvironment || ''} onChange={e=>setEditingProject({...editingProject, sourceEnvironment: e.target.value})} className="w-full p-2 border border-slate-300 rounded focus:border-blue-500 outline-none text-sm font-bold" /></div>
