...
export default function MasterPipeline() {
    ...
    const getHealthBadge = (h) => { 
        if(h==='Green') return <span className="bg-emerald-100 text-emerald-800 px-2 py-0.5 rounded text-[9px] font-bold border border-emerald-200"><i className="fas fa-check-circle"></i> On Track</span>; 
        if(h==='Red') return <span className="bg-rose-100 text-rose-800 px-2 py-0.5 rounded text-[9px] font-bold border border-rose-200"><i className="fas fa-times-circle"></i> Blocked</span>; 
