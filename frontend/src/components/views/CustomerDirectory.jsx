                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 relative shadow-sm">
                    ...
                    <div className="flex justify-between items-end">
                      <div className="grid grid-cols-3 gap-4 flex-1 mr-4">
                        <div><label className="block text-[9px] font-black text-blue-700 uppercase tracking-widest mb-1">Source Region</label><select value={editingCustomer.source_huawei_region || ''} onChange={e => setEditingCustomer({ ...editingCustomer, source_huawei_region: e.target.value })} className="w-full p-2.5 border border-blue-300 rounded-lg text-xs font-mono outline-none focus:border-blue-500 bg-white cursor-pointer"><option value="">Select region...</option><option value="la-south-2">Santiago, Chile (la-south-2)</option><option value="la-north-2">Mexico City, Mexico (la-north-2)</option><option value="sa-brazil-1">São Paulo, Brazil (sa-brazil-1)</option><option value="ap-southeast-3">Singapore (ap-southeast-3)</option><option value="cn-north-4">Beijing (cn-north-4)</option><option value="cn-east-3">Shanghai (cn-east-3)</option><option value="ap-southeast-1">Hong Kong (ap-southeast-1)</option><option value="ap-southeast-2">Bangkok (ap-southeast-2)</option><option value="eu-west-101">Dublin (eu-west-101)</option><option value="af-south-1">Johannesburg (af-south-1)</option></select></div>
