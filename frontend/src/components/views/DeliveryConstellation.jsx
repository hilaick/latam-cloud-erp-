...
const STATIC_PHASES = [
  ...
  { id:'phase_2', label:'Architecture',           summary:'Source discovery, risk profiling, and target topology design', color:PHASE_COLORS[1], icon:PHASE_ICONS[1], gates:['Architecture Summary complete','Source Discovery complete','ORA Risk Profile assessed','Target Topology Mapped','DTRB Governance approved'] },
  { id:'phase_3', label:'Planning',               summary:'Technical feasibility, delivery physics, FinOps budgeting, and wave planning',       color:PHASE_COLORS[2], icon:PHASE_ICONS[2], gates:['Technical Feasibility assessed','WBS & RACI Matrix defined','Physics Engine calibrated','FinOps Budget & Burn approved','Strategic Tooling selected','Execution Mode selected','Wave & Runbook planned'] },
