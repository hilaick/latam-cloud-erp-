...
export default function Sidebar() {
    ...
    // Listen for clicks outside the desktop/mobile menus to auto-close them
    useEffect(() => {
    ...
    return (
        <>
            ...
            {/* 🚨 DESKTOP SIDEBAR (Single Slide-in overlay, no duplicates) */}
            <div 
            ...
            >
                {/* Notice pl-16 prevents the header text from sitting underneath the hamburger button */}
