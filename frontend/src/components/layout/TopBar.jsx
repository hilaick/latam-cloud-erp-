    ...
    return (
        <div className="bg-white border-b border-slate-200 px-4 md:px-6 py-4 flex items-center justify-between sticky top-0 z-40 shadow-sm shrink-0">
            <div className="flex items-center gap-4 md:gap-6">
                {/* 🚨 FIX: Removed lg:hidden, now visible everywhere to collapse sidebar */}
                <button 
                    onClick={() => setSidebarOpen(prev => !prev)} 
                    className="text-slate-500 hover:text-blue-600 transition-colors p-2 rounded-lg hover:bg-slate-100 flex items-center justify-center h-10 w-10 border border-transparent hover:border-slate-200"
                ...
                <div className="flex items-center gap-3">
                    <div className="hidden sm:flex w-10 h-10 rounded-xl bg-blue-50 border border-blue-100 items-center justify-center text-blue-600 shadow-inner">
                        <i className="fas fa-building"></i>
                    </div>
                    <div>
                        <div className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-0.5 hidden sm:block">
                        ...
                        <select 
                            ...
                            onChange={(e) => {
                                ...
                                if (e.target.value !== 'none') setActivePhase('wizard');
                            }}
            ...
            <div className="flex items-center gap-4">
                ...
                <div 
                    ...
                    title="Hilaick Yard (Master Admin)"
                >
                    HY
                </div>
            </div>
