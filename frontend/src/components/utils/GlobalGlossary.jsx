...
export default function GlobalGlossary() {
    ...
    return (
        <>
            ...
            <button 
                ...
                className="fixed bottom-8 right-8 z-[9000] w-14 h-14 bg-slate-800 hover:bg-indigo-600 text-white rounded-full shadow-2xl flex items-center justify-center transition-all hover:scale-110 active:scale-95 border-2 border-slate-700 hover:border-indigo-400 group"
                title="Terminology Glossary & Help"
            >
                <i className="fas fa-question text-xl group-hover:rotate-12 transition-transform"></i>
            </button>
