...
function CommercialTrueUpView({ activeProject, onUpdateProject }) {
    ...
    const handleClearQuotation = async () => {
        if (!window.confirm('Are you sure you want to clear the uploaded quotation? This will remove all ECS RI data for this project.')) {
            return;
        }
    ...
    return (
        <div className="max-w-[1600px] mx-auto space-y-6 animate-fade-in">
            ...
            {/* 🚨 MOVED: RAW IMPORT Modal is now correctly inside the CommercialTrueUpView component */}
