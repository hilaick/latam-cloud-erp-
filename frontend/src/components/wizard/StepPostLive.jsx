        ...
        <div className="animate-fade-in pb-12">
            ...
            <div className="mb-8 border-b border-slate-200 pb-4 flex flex-col md:flex-row justify-between items-start md:items-end gap-4 px-4 md:px-8">
                <div>
                    ...
                    <p className="text-sm text-slate-500 mt-2">3-Way Reconciliation, Live Topology mapping, and WAR Sign-Off.</p>
                </div>
                {isCurrent && (
            ...
            <div className="px-4 md:px-8 flex flex-wrap gap-2 border-b border-slate-200 pb-4 mb-6">
                ...
                <button 
                    ...
                    className={`px-4 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all shadow-sm ${subTab === 'topology' ? 'bg-blue-600 text-white' : 'bg-white text-slate-600 border border-slate-200 hover:bg-slate-100'}`}
                >
                    <i className="fas fa-project-diagram mr-2"></i> 2. Live Target Topology
                </button>
                <button 
            ...
            <div className="px-4 md:px-8">
                ...
                {subTab === 'topology' && <LiveTopologyView activeProject={project} />}
...
// ==========================================
// 🌌 2. INTERACTIVE LIVE TOPOLOGY
// ==========================================
function LiveTopologyView({ activeProject }) {
    ...
    if (targetNodes.length === 0) {
        return (
            <div className="bg-slate-900 rounded-2xl border-2 border-dashed border-slate-700 p-16 text-center text-slate-500 animate-fade-in max-w-[1600px] mx-auto shadow-xl">
                <i className="fas fa-project-diagram text-6xl mb-4 text-slate-700"></i>
                <h3 className="font-black text-xl mb-2 text-white">Topology Offline</h3>
                <p className="font-medium text-sm">No live API telemetry found. Run the Final NOC Scan in Tab 1 to generate the Topology Graph.</p>
            </div>
        );
    }
                ...
                <div className="absolute top-4 left-4 right-4 z-40 flex justify-between items-start pointer-events-none">
                    <div className="bg-slate-800/90 backdrop-blur border border-slate-700 px-5 py-3 rounded-xl shadow-lg pointer-events-auto">
                        <h3 className="font-black flex items-center gap-3 text-lg text-white">
                            <i className="fas fa-project-diagram text-blue-500"></i> Live Target Topology
                        ...
                        <p className="text-[10px] text-slate-400 mt-1 uppercase tracking-widest font-bold">Interactive Resource Graph</p>
                    </div>
