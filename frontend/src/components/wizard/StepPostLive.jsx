                                ...
                                <tbody className="divide-y divide-slate-100">
                                    {matrix.length === 0 ? (
                                        ...
                                        <tr key={i} className="hover:bg-slate-50 transition-colors">
                                            ...
                                            <td className={`p-3 text-center font-black ${asset.live_count > 0 ? 'text-emerald-700 bg-emerald-50/30 cursor-pointer hover:bg-emerald-100' : 'text-slate-400 bg-slate-50/30'}`} onClick={() => asset.live_count > 0 && setDetailsModal({show: true, title: `Provisioned (Live ECS): ${asset.specification}`, items: asset.live_servers})}>
                                    ...
                                    <tbody className="divide-y divide-rose-50">
                                        {unquotedMatrix.map((asset, i) => {
                                            ...
                                            <tr key={i} className="hover:bg-rose-50/30 transition-colors">
                                                ...
                                                <td className="p-3 text-center font-black text-purple-700 bg-purple-50/30 cursor-pointer hover:bg-purple-100" onClick={() => asset.bought_count > 0 && setDetailsModal({show: true, title: `Owned RIs: ${asset.specification}`, items: asset.bought_ris})}>
                                                    {asset.bought_count} {asset.bought_count > 0 && <i className="fas fa-search-plus ml-1 opacity-50 text-[10px]"></i>}
                                                </td>
