...
export default function GovernanceAndCRView({ activeProject, onUpdateProject }) {
    ...
    // 🚨 DTRB RULES ENGINE (Strictly Technical Governance)
    ...
    const handleSubmitCR = () => {
        ...
        // Save CR so Phase 3 FinOps can read the cost later
        ...
        <div className="animate-fade-in max-w-[1200px] mx-auto pb-12 relative mt-6">
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 mb-8">
                    ...
                    {/* RIGHT COLUMN: CHANGE REQUEST LOG */}
                            ...
                            {changeRequests.length === 0 ? (
                                ...
                                changeRequests.map(cr => (
                                    <div key={cr.id} className="bg-slate-50 border border-slate-200 p-4 rounded-xl relative">
                                        ...
                                        <div className="text-[10px] font-black uppercase tracking-widest text-slate-500 border-t border-slate-200 pt-2">Cost Impact: <span className="text-rose-600">${cr.cost}</span> (Feeds to FinOps)</div>
                                    </div>
                                ))
                            )}
                        </div>
