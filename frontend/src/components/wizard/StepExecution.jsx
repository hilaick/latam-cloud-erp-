...
export default function StepExecution({ project, onUpdateProject, onPromote }) {
    ...
    return (
        <div className="max-w-[1600px] mx-auto pb-12 animate-fade-in relative space-y-6">
            ...
            {/* 🚨 RESTORED: 3-TAB EXECUTION NAVIGATION */}
            <div className="flex gap-2 border-b border-slate-200 pb-4 mb-6 flex-wrap">
                ...
                <button 
                    ...
                    className={`px-4 py-2 rounded-lg text-xs font-bold transition-colors ${subTab === 'tam' ? 'bg-purple-600 text-white shadow-sm' : 'bg-white text-slate-600 border border-slate-200 hover:bg-slate-50'}`}
                >
