...
def register_hermes_sockets(socketio):
    """
    Dynamically binds the WebSocket event listener directly to the initialized SocketIO 
    instance to completely avoid Circular Import issues with app.py.
    """
    socketio.on_event('hermes_query_stream', handle_hermes_stream)
