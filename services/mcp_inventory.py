...
ACTION_MAP = {
    "CREATE_TARGET_ECS": {"service": "ecs", "method": "POST", "path_kw": "cloudservers", "op_kw": "CreateServer"},
    "SHOW_ECS": {"service": "ecs", "method": "GET", "path_kw": "cloudservers", "op_kw": "ShowServer"},
    "LIST_ECS": {"service": "ecs", "method": "GET", "path_kw": "cloudservers/detail", "op_kw": "ListServersDetails"},
    "CREATE_VPC": {"service": "vpc", "method": "POST", "path_kw": "vpcs", "op_kw": "CreateVpc"},
    "CREATE_SUBNET": {"service": "vpc", "method": "POST", "path_kw": "subnets", "op_kw": "CreateSubnet"},
    "CREATE_SG": {"service": "vpc", "method": "POST", "path_kw": "security-groups", "op_kw": "CreateSecurityGroup"},
    "CREATE_SG_RULE": {"service": "vpc", "method": "POST", "path_kw": "security-group-rules", "op_kw": "CreateSecurityGroupRule"},
    "CREATE_EIP": {"service": "eip", "method": "POST", "path_kw": "publicips", "op_kw": "CreatePublicip"},
    ...
    "VALIDATE_CREDENTIALS": {"service": "iam", "method": "GET", "path_kw": "regions", "op_kw": "KeystoneListRegions"},
    "LIST_PROJECTS": {"service": "iam", "method": "GET", "path_kw": "projects", "op_kw": "KeystoneListProjects"},
    "HSS_LIST_HOSTS": {"service": "hss", "method": "GET", "path_kw": "hosts"},
    "EPS_CREATE": {"service": "eps", "method": "POST", "path_kw": "enterprises", "op_kw": "CreateEnterpriseProject"},
    # Discovery (Phase 2)
