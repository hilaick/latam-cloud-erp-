            ...
            <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="w-full lg:w-80 shrink-0 bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden h-[600px] flex flex-col">
                    ...
                    <div className="flex-1 overflow-y-auto p-2 space-y-1">
                        {customers.length === 0 && <div className="p-8 text-center text-xs font-bold text-slate-400 border-2 border-dashed border-slate-200 rounded-xl m-2">No customers generated yet. Move a lead to the pipeline to auto-generate an account.</div>}
                        {customers.map(c => (
