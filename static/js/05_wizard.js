    ...
    return (
        <div className="p-8">
            <div className="mb-8 border-b border-slate-200 pb-4 flex justify-between items-end">
                <div><h3 className="font-black text-2xl text-slate-800"><i className="fas fa-door-open text-blue-600 mr-3"></i> Step 1: ARB Intake Gate</h3><p className="text-sm text-slate-500 mt-2">Validate the technical SOW and Architectures provided by the Sales Architect.</p></div>
